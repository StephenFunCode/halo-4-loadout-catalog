...
| Regen Field: stationary sphere (~10 Spartans across), shields of anyone inside including enemies, ~3s to full (no wait); default shields ~6s wait then ~2s fill; Shielding does not stack in-field (step out for the faster fill); incoming fire delays; 1.5s plant | Default wait/fill: [Halopedia Shielding](https://www.halopedia.org/Tactical_packages) (6s wait) and [energy shielding](https://halo.fandom.com/wiki/Energy_shielding) (2s fill). Field fill, radius, plant lock: [The Balance, Nov 2012](http://balance-reviews.blogspot.com/2012/11/halo-4-multiplayer-armor-ability-guide.html). Stationary / jump-out / Shielding: Forge [GameFAQs 64619938](https://gamefaqs.gamespot.com/boards/632877-halo-4/64619938). Enemies share the field: Fandom Regen Field. Shots pass through, activation shove, blur: Halopedia Regen Field. Do not say leaving the field stops regen; with Shielding, leaving is faster. Blur/distortion is while inside; Halopedia’s “exit once shields are full” is advice, not a condition for the blur to clear. |
...
| Stealth PV outline vs filled figure; sprint quieter; still on radar | David Ellis (343) in [IGN / Halo Diehards recap](https://www.halodiehards.net/halo-4-specializations-breakdown/). Bulletin 8.15.12: outline only, sound dampening when sprinting. Assassination 20%: [Halopedia Support upgrades](https://www.halopedia.org/Support_upgrades). Do not write “thinner profile.” |
